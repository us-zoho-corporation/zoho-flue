...
| [Get Fields](references/get-fields.md) | `GET /crm/v8/settings/fields` | Get field definitions for a module |
...
`ZohoCRM.settings.modules.READ` (list/get module), `ZohoCRM.settings.fields.READ` (get fields), `ZohoCRM.settings.fields.ALL` (create/delete field), `ZohoCRM.settings.modules.ALL` (create/delete module, profile lookup during module creation)
